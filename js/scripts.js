...
$.getJSON("https://raw.githubusercontent.com/Andre9424/PLATAFORMA_VISADO_MUNICIPAL/main/capas/NacientesWGS84.geojson", function(geodata) {
...
$.getJSON("https://raw.githubusercontent.com/Andre9424/PLATAFORMA_VISADO_MUNICIPAL/main/capas/cantonWGS84.geojson", function(geodata) {
...
$.getJSON("https://raw.githubusercontent.com/Andre9424/PLATAFORMA_VISADO_MUNICIPAL/main/capas/distritosWGS84.geojson", function(geodata) {
  var capa_distrito = L.geoJson(geodata, {
    style: function(feature) {
	  return {'color': "#000000", 'weight': 2.0, 'fillOpacity': 0.0}
    }}).addTo(mapa);

  control_capas.addOverlay(capa_distrito, 'Distrito');
});

//---------------------------------------------------------------//

// Capa raster
var capa_pendientes = L.imageOverlay("https://raw.githubusercontent.com/Andre9424/PLATAFORMA_VISADO_MUNICIPAL/main/capas/pendirecWGS84.png", 
	[[9.6223412691860801, -84.3418993877406109], 
	[9.8616843904909679, -84.1319159426894743]], 
	).addTo(mapa);
control_capas.addOverlay(capa_pendientes, 'Mapa de Pendientes');
...
$.getJSON('https://raw.githubusercontent.com/Andre9424/PLATAFORMA_VISADO_MUNICIPAL/main/capas/zhacosta.geojson', function (geojson) {
...
//Mini mapa//
	...
	attribution: 'Tiles &copy; Esri &mdash; Source: Esri, i-cubed, USDA, USGS, AEX, GeoEye, Getmapping, Aerogrid, IGN, IGP, UPR-EGP, and the GIS User Community'
		...
		var miniMap = new L.Control.MiniMap(sat, { toggleDisplay: true, position: 'bottomleft', width: 250, height: 250 }).addTo(mapa);
